...
impl From<OpCode> for u16 {
    fn from(value: OpCode) -> Self {
        match value {
            ...
            OpCode::SkipIfEqualRegister(x, y)       => 0x5000 | shift_3(x) | shift_2(y) | 0x0,
            OpCode::StoreValue(x, nn)               => 0x6000 | shift_3(x) | /**********/ nn as u16,
            OpCode::AddValue(x, nn)                 => 0x7000 | shift_3(x) | /**********/ nn as u16,
            OpCode::StoreRegister(x, y)             => 0x8000 | shift_3(x) | shift_2(y) | 0x0,
            OpCode::Or(x, y)                        => 0x8000 | shift_3(x) | shift_2(y) | 0x1,
            OpCode::And(x, y)                       => 0x8000 | shift_3(x) | shift_2(y) | 0x2,
            OpCode::Xor(x, y)                       => 0x8000 | shift_3(x) | shift_2(y) | 0x3,
            OpCode::AddRegister(x, y)               => 0x8000 | shift_3(x) | shift_2(y) | 0x4,
            OpCode::SubtractRegister(x, y)          => 0x8000 | shift_3(x) | shift_2(y) | 0x5,
            OpCode::ShiftRight(x, y)                => 0x8000 | shift_3(x) | shift_2(y) | 0x6,
            OpCode::SubtractRegisterReverse(x, y)   => 0x8000 | shift_3(x) | shift_2(y) | 0x7,
            OpCode::ShiftLeft(x, y)                 => 0x8000 | shift_3(x) | shift_2(y) | 0xE,
            OpCode::SkipIfNotEqualRegister(x, y)    => 0x9000 | shift_3(x) | shift_2(y) | 0x0,
